...
class Ator():
    ...
    def colidir(self, outro_ator, intervalo=1):
        ...
        :return:
        """
        largura = self.x + intervalo
        profundidade = self.y + intervalo
...
class Passaro(Ator):
    ...
    def _calcular_posicao_vertical(self, delta_t):
        ...
        y_atual += self.velocidade_escalar * math.sin(self._angulo_de_lancamento)*delta_t - GRAVIDADE * delta_t**2 / 2
        self.y = y_atual
